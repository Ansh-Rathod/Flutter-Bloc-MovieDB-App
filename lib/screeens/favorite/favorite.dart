...
import 'package:amd/screeens/favorite/bloc/collection_tab_bloc.dart';
import 'package:amd/screeens/favorite/collections.dart';
import 'package:amd/screeens/favorite/streams/favorites_stream.dart';
import 'package:amd/screeens/favorite/watchlist.dart';
import 'package:amd/screeens/info_pages/movies_info/bloc/movies_info_bloc.dart';
import 'package:amd/screeens/info_pages/movies_info/movies_info.dart';
import 'package:amd/screeens/info_pages/tv_shows_info/bloc/show_info_bloc.dart';
import 'package:amd/screeens/info_pages/tv_shows_info/tv_show_info.dart';
  ...
  moveToInfo(BuildContext context) {
    if (widget.movie.isMovie) {
      pushNewScreen(
        ...
        screen: BlocProvider(
          create: (context) =>
              MoviesInfoBloc()..add(LoadMoviesInfo(id: widget.movie.id)),
          child: MoivesInfo(
            image: widget.movie.backdrop,
      ...
      pushNewScreen(
        ...
        screen: BlocProvider(
          create: (context) =>
              ShowInfoBloc()..add(LoadTvInfo(id: widget.movie.id)),
          child: TvInfo(
            image: widget.movie.backdrop,
            title: widget.movie.name,
          ),
